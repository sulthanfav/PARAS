...
// Komponen PengaturanIsiUMKM
const PengaturanIsiUMKM: Component = () => {
    //-----------------------------------------------------
          ...
          <div class="bg-all">
            ...
            <div class='bodyprofile'>
              <div class='bodycontent-pengaturan'>
                ...
                <div class='bodyform'>
                  <div class='form-profile'>Buat Kata Sandi Baru</div>
                  <div><input type="text" class="isianprofile input input-bordered w-full max-w-xs" /></div>
                </div>
                <div class='bodyform'>
                  <div class='form-profile'>Konfirmasi Kata Sandi Baru</div>
                  <div><input type="text" class="isianprofile input input-bordered w-full max-w-xs" /></div>
                </div>
                <div class='btn-bawah'>
                  <div class='btn-batal'><input type="reset" value="Reset" class="batal" /></div>
                  <div class='btn-simpan'><button type="submit" value="Submit" class="simpan" >Simpan</button></div>
                </div>
              </div>
            </div>
          </div>
...
export default PengaturanIsiUMKM;
