...
import './popup_lagi_reply.css';
import { A,useNavigate } from "@solidjs/router";
import { Icon } from "@iconify-icon/solid";

const Popup_lagi_reply: Component = () => {
    return (
        <>
     <div class="notif">
            <div class="judul">
        ...
        <div class="container-reply">
            ...
            <input class="reply-text" type="text" placeholder="Tulis komentar Anda disini"/>
    ...
    export default Popup_lagi_reply;