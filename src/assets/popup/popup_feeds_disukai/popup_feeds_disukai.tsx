...
import './popup_feeds_disukai.css';
import { A,useNavigate } from "@solidjs/router";
import { Icon } from "@iconify-icon/solid";

const Popup_feeds_disukai: Component = () => {
    return (
        <>
     <div class="notif">

            <div class="judul">
                <div class="numani-judul">
                    <img  src='src/assets/image/numani_reply.png'> </img>
                </div>
                <div class="info-toko">
                <div class="nama-toko"> Numani </div>
                <div class="deskripsi-toko">Berjualan Hijab Paris Lokal Asli</div>
    ...
    export default Popup_feeds_disukai;